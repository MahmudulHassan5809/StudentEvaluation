...
function geoFail() {
    ...
    $("#weather_section").after('<div class="location-search"><h4 class="text-center">Find your local weather</h4><span><input type="text" class="form-control" name="input-field" autofocus placeholder="92554 or San Francisco, CA"><button class="btn btn-sm btn-outline-success m-0 p-0" type="button" name="search"><i class="fa fa-search" aria-hidden="true"></i> Search</button></span></div>');
