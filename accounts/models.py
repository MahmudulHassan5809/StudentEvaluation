...
class Teacher(models.Model):
    ...
    department = models.ForeignKey(
        Department, on_delete=models.CASCADE, related_name='department_teacher')
    faculty = models.ForeignKey(
        Faculty, on_delete=models.CASCADE, related_name='faculty_teacher')
...
class Student(models.Model):
    ...
    department = models.ForeignKey(
        Department, on_delete=models.CASCADE, related_name='department_student')
    faculty = models.ForeignKey(
        Faculty, on_delete=models.CASCADE, related_name='faculty_student')
